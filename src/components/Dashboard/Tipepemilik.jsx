...
import Tipe from "../../data/tipemilik.json";
import {
       ...
       {isLoading ? ( // Tampilkan CircularProgress jika isLoading true
        ...
        <Table>
          <TableHead>
              ...
              <TableCell align='center' style={{ backgroundColor: ' #0288d1', color: 'white' }}>Tipe Pemilik</TableCell>
            ...
            {data.map((item, index) => (
                ...
                <TableCell >{item.tipepemilik}</TableCell>
